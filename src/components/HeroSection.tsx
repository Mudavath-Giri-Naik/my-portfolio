...
const HeroSection = () => {
  return (
    <section className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden bg-background pt-16 md:pt-20 px-4">
      ...
      {/* Comment Boxes - Positioned in corners, hidden on mobile */}
      {/* Top Left */}
      <div className="hidden md:block absolute top-24 left-4 lg:left-12 xl:left-20 z-20">
      ...
      {/* Top Right */}
      <div className="hidden md:block absolute top-24 right-4 lg:right-12 xl:right-20 z-20">
        <div className="transform rotate-3 hover:rotate-0 transition-transform duration-300">
      ...
      {/* Bottom Left */}
      <div className="hidden md:block absolute bottom-36 left-4 lg:left-16 xl:left-28 z-20">
      ...
      {/* Bottom Right */}
      <div className="hidden md:block absolute bottom-36 right-4 lg:right-16 xl:right-28 z-20">
        <div className="transform -rotate-2 hover:rotate-0 transition-transform duration-300">
